...
HD_PWD='D:/vivado projects/JZ_project_2/JZ_project_2/JZ_project_2.runs/data_memory_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_memory_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_memory_ip.tcl
